...
export const waves: WaveInstructions = [
    ...
    [
        {
            enemy:               mailEnemy,
            count:               15,
            timeBetweenSpawnsMs: 6_500
        },
    ],
    // Wave 3 - Introduce the teams meeting enemy
    [
        {
            enemy:                mailEnemy,
            count:                8,
    ...
    // Wave 4 - Introduce the plane enemy, give the player some more time to clear out the mail enemies first
    [
        {
            enemy:                mailEnemy,
            count:                10,
